...
**BR-44:** Open question dijawab sekali oleh kontak terverifikasi via portal; jawaban immutable (tidak dapat ditimpa) — diskusi lanjutan lewat komentar. Sinkronisasi open question dari sumber derived bersifat idempoten dan tidak menyentuh item yang sudah dijawab.
...
**BR-54:** Rule validator heuristik (pairing keyword/angka seperti fact drift) berbobot maksimal info — alarm untuk ditinjau manusia, bukan vonis. Hanya rule deterministik-terverifikasi yang boleh berbobot warning/critical. Nomor section/heading, penomoran leading-zero, dan kode status HTTP bukan klaim angka.
