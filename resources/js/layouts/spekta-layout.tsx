            ...
            <aside className="sticky top-0 flex h-screen w-[250px] flex-none flex-col border-r border-gray-200 bg-white">
                ...
                <div className="mx-4 mb-3.5 flex cursor-default items-center justify-between rounded-[10px] border-2 border-gray-200 px-2.5 py-2">
                    <div className="flex min-w-0 items-center gap-2 text-[13px] font-bold text-gray-800">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0D9488" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="flex-none">
                            <path d="M3 21h18" />
                    ...
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className="flex-none">
