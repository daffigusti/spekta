...
class GenerateMissingTest extends TestCase
{
    ...
    public function test_generate_missing_docs_completes_full_pipeline(): void
    {
        ...
        // Wizard cepat: kompleksitas 2 → set 7 dokumen (termasuk WIREFRAMES)
        ...
        $this->assertSame(7, $project->documents()->count());
        ...
        $this->assertSame(8, $project->documents()->count());
        ...
        $this->assertSame(12, $project->documents()->count());
